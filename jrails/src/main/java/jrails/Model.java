...
public class Model {
    ...
    private LinkedList <Integer> materializedId = new LinkedList<Integer>();
    ...
    public void save() {
        ...
        25
        Total models: 25
        when 25 is saved, it should only save that rather than the whole thing, 
        have a seperate list of ids, and when saved, add that to list 
        */
    }
    ...
    public void destroy() {
        ...
        materializedId.remove(recordedId);
